...
import { addSmurf, errMessage } from "../actions"
...
const AddForm = (props) => {
    ...
    const handleSubmit = e => {
        ...
        if (state.name === "" || state.position === "" || state.nickname === "") {
            props.errMessage("Name, position and nickname fields are required.");
        }else{
    ...
    return(<section>
        ...
        <form onSubmit={handleSubmit}>
            ...
            {
                props.error && <div data-testid="errorAlert" className="alert alert-danger" role="alert">Error: {errorMessage}</div>
            }
...
export default connect(mapStateToProps, { errMessage, addSmurf})(AddForm);
